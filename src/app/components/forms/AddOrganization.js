...
export default function AddOrganizationForm({
  onSubmit,
  initialValues = defaultOrganizationValues,
  isLoading = false,
  tags,
  onClose,
}) {
  ...
  // Filter tenants to only show those where user can create organizations
  ...
  const onSubmitWrapper = async (data) => {
    ...
    if (!selectedTenant?.id) {
      toast.error("Please select a tenant for this organization");
      return;
    }
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <MultiSelect
              ...
              label="Tags"
              required={false}
              placeholder="Enter organization tags"
              options={tags}
              value={selectedTags}
          ...
          <h2 className="text-xl font-semibold ">Organization Type</h2>
